...
implicit none
  ...
  double precision   :: dfillValue = 9.96921d+36
  ...
  do tile = 1, tiles
    ...
    call unf90_io_var(incid, nx, ny, glon(:,:,tile),      'geolon')
    call unf90_io_var(incid, nx, ny, glat(:,:,tile),      'geolat')
    call unf90_io_var(incid, nx, ny, land_frac(:,:,tile), 'land_frac')
    call unf90_io_var(incid, nx, ny, orog_raw(:,:,tile),  'orog_raw')
    call unf90_io_var(incid, nx, ny, orog_filt(:,:,tile), 'orog_filt')
    call unf90_io_var(incid, nx, ny, slmsk(:,:,tile),     'slmsk')
...
! call unf90_out_varatt(oncid, 'longitude', '_FillValue', dfillValue)
