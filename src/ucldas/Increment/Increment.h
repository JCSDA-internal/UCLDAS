...
#ifndef UCLDAS_INCREMENT_INCREMENT_H_
#define UCLDAS_INCREMENT_INCREMENT_H_
...
namespace ucldas {
  ...
  class Increment : public oops::GeneralizedDepartures,
   ...
   public:
      static const std::string classname() {return "ucldas::Increment";}
...
#endif  // UCLDAS_INCREMENT_INCREMENT_H_
